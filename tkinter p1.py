...
windows.title("This is my first TKinter program")
...
button2=tk.Button(windows, fg="#EAA408", text="GREEN", command=green, activebackground="green", activeforeground= "red", height=2, width=40, font=("Arial", 18))
button3=tk.Button(windows, fg="#EA408",text="BLUE", command=blue, activebackground="blue", activeforeground="red", height=2, width=40, font=("Consolas",18))
label1.pack()
button1.pack()
button2.pack()
button3.pack()
